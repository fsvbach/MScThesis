...
\begin{frame}{}
\begin{figure}
\includegraphics[height=0.95\textheight]{HGM/RandomHGM.pdf}
\end{figure}
\end{frame}
...
Now we introduce a hyperparameter $w \in [0,1]$, that puts emphasis either on means or covarariances.
...
\begin{figure}
\includegraphics[width=0.95\textwidth]{HGM/CleanExample.pdf}
\end{figure}
\end{frame}
