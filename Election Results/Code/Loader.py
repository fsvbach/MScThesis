...
class Gemeinden:
    def __init__(self, nonvoters=True):
        ...
        data = pd.read_csv('Data/BW/Gemeinden.csv', delimiter=';', encoding='ISO-8859-1', index_col='Gemeinde')
    ...
    def colors(self):
        colors = pd.read_csv('Data/BW/Farben.csv', delimiter=';', encoding='utf-8', header=0)
...
class Germany:
    data = pd.read_csv('Data/GER Wahlkreise.csv', delimiter=';',
...
class Wahlkreise:
    def __init__(self, nonvoters=True):
        ...
        data = data = pd.read_csv('Data/BW/Kreise.csv', delimiter=';', encoding='ISO-8859-1', index_col='Wahlkreis')
